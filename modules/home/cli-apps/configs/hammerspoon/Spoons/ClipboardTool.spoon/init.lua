...
function obj:_showContextMenu(row)
  ...
  local menuTable = {
       { title = "Remove entry",  fn = hs.fnutils.partial(self.deleteClip, self, row) },
   }
...
function obj:start()
   ...
   self.selectorobj:placeholderText("Search pasteboard…")
